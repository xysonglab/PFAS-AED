...
def add_train_args(parser: ArgumentParser):
    ...
    parser.add_argument('--calibrate_confidence', action='store_true', default=False,
                        help='Calibrate confidence by test data.')
    ...
    # Adaptive Evidential Loss Arguments
    parser.add_argument('--temperature', type=float, default=1,
                        help='Temperature parameter for uncertainty calibration in adaptive evidential loss')
    parser.add_argument('--use_adaptive_reg', action='store_true', default=False,
                        help='Use confidence-adaptive regularization in evidential loss')
    parser.add_argument('--use_robust_loss', action='store_true', default=False,
                        help='Use robust (Huber-like) loss component for outlier handling')
    parser.add_argument('--huber_delta', type=float, default=1.0,
                        help='Threshold for Huber loss transition in robust loss')
    parser.add_argument('--use_calibration', action='store_true', default=False,
                        help='Use calibration term to match predicted variance with actual error')
    parser.add_argument('--calibration_weight', type=float, default=0.1,
                        help='Weight for calibration loss term')
    parser.add_argument('--use_diversity_reg', action='store_true', default=True,
                        help='Use diversity regularization to prevent uncertainty collapse')
...
def modify_train_args(args: Namespace):
    ...
    # Set dataset_type to regression
    ...
    # Validate metric for regression
    if args.metric not in ['rmse', 'mae', 'r2']:
        raise ValueError(
            f'Metric "{args.metric}" invalid for regression tasks.')
